...
public class Persist {
    ...
    public File getFile(String name) {
        return new File(BRBarriers.getInstance().getDataFolder(), name + ".json");
    }
    ...
    public <T> T loadOrSaveDefault(T def, Class<T> clazz, File file) {
        if (!file.exists()) {
            BRBarriers.getInstance().getLogger().info("Creating default: " + file);
            this.save(def, file);
            return def;
        }
        ...
        if (loaded == null) {
            BRBarriers.getInstance().getLogger().warning("Using default as I failed to load: " + file);
            ...
            BRBarriers.getInstance().getLogger().warning("Backing up copy of bad file to: " + backup);
    ...
    public <T> T load(Class<T> clazz, File file) {
        ...
        try {
            ...
            BRBarriers.getInstance().getLogger().warning(ex.getMessage());
        }
